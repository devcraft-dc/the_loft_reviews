...
export const CategoryFilter = () => (
  <div className="fixed bottom-0 w-[500px] max-lg:w-full">
    <Search />
    <div className="flex gap-6 p-5 max-md:p-4 max-sm:p-3 items-end bg-main-black overflow-x-auto scrollbar-thin scrollbar-thumb-main-black scrollbar-track-secondary-white scrollbar-thumb-rounded-md">
      {icons.map((icon) => (
